...
export function FloatingEmojiPicker({
  ...
  useEffect(() => {
    ...
    setPosition({ top: rect.top - 52, left: rect.left });
  ...
  return (
    <div
      className="fixed z-50 rounded-full border border-[var(--color-ink)]/10 bg-[var(--color-bg)] p-1 shadow-[0_10px_30px_-10px_rgba(42,26,18,0.35)]"
