...
const KEKERE_PROTECTED_PREFIXES = ["/kekere/feed", "/kekere/wallet", "/kekere/library", "/kekere/profile", "/kekere/write", "/kekere/notes", "/kekere/settings", "/kekere/preferences", "/kekere/analytics", "/kekere/review"];
