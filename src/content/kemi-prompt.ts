...
- **Cowries** are the in-app currency. Readers unlock stories with cowries; most of that goes straight to the writer. Every new reader's very first story is free — no cowries needed. Top up cowries from the Wallet tab — card payment works from anywhere in the world, priced in the reader's local currency — and bigger packages include bonus cowries. Cowries never expire.
