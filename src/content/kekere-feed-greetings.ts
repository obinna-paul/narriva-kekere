...
const GREETINGS: readonly GreetingTemplate[] = [
  ...
  { text: "Somewhere, someone just found out a secret. You could too." },
  { text: "{name}, low effort, high reward. Can't complain." },
  { text: "This won't fix your day. It might improve five minutes of it." },
  ...
  { text: "Two minutes in, you'll forget you had anywhere else to be." },
  { text: "{name}, back for more? Bold and correct." },
  { text: "Somewhere, a plot is unraveling on schedule." },
  { text: "{name}, the door's open. Come make questionable time choices." },
  ...
  { text: "Something's about to go wrong for someone. Not you, {name}." },
